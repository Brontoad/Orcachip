...
PYBIND11_MODULE(orcachip_core, m) {
    ...
    py::class_<VectorSearchEngine>(m, "VectorSearchEngine")
        .def_readonly("embeddings_ptr", &VectorSearchEngine::embeddings_ptr)
        .def_readonly("dimensions", &VectorSearchEngine::dimensions)
        .def_readonly("total_bytes", &VectorSearchEngine::total_bytes)
        .def_readonly("embedding_floats", &VectorSearchEngine::embedding_floats)
        .def_readonly("total_vectors", &VectorSearchEngine::total_vectors)
